...
var resumeDisplayElement = document.getElementById('resume-display') as
HTMLDivElement;

var shareableLinkContainer = document.getElementById('shareable-link-container') as HTMLDivElement;

var shareableLinkElement = document.getElementById('shareable-link') as
HTMLAnchorElement;
var downloadPdfButton = document.getElementById('download-pdf') as
HTMLButtonElement;
